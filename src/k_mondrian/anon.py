...
def main():
    ...
    output_dir = f'datasets/k_mondrian/'
    metrics_dir = f'metrics/mondrian/'
    ...
    metrics_df.to_csv(f'{metrics_dir}mondrian_metrics.csv', index=False)
    print("\nMétricas salvas em:", f'{metrics_dir}mondrian_metrics.csv')
